...
<?= $this->section('title') ?>Add Cash Customer<?= $this->endSection() ?>

<?= $this->section('content') ?>
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Customers / Cash Customers /</span> Add New Customer</h4>
...
<div class="row">
    <div class="col-md-12">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="<?= base_url('customers/cash-customers') ?>" method="POST" id="createCashCustomerForm">
                    <?= csrf_field() ?>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-text">Mobile + Name combination must be unique.</div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="pincode" name="pincode" pattern="[0-9]{6}" maxlength="6" value="<?= old('pincode') ?>">
                        </div>
