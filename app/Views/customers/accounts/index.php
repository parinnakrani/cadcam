      ...
      columns: [{
        ...
        },
        {
          ...
          render: function(data, type, row) {
            ...
            if (canView) {
              html += `<a class="dropdown-item" href="<?= base_url('customers/accounts') ?>/${data}"><i class="ri-eye-line me-1"></i> View</a>`;
            }
            if (canEdit) {
              html += `<a class="dropdown-item" href="<?= base_url('customers/accounts') ?>/${data}/edit"><i class="ri-pencil-line me-1"></i> Edit</a>`;
            }
            if (canDelete) {
