                    ...
                    <form action="<?= base_url('masters/gold-rates/store') ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="rate_date" name="rate_date" 
                                   value="<?= old('rate_date', $today) ?>" required max="<?= date('Y-m-d') ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="metal_type" name="metal_type" required>
                                <option value="22K" <?= old('metal_type') == '22K' ? 'selected' : '' ?>>22K Gold</option>
                                <option value="24K" <?= old('metal_type') == '24K' ? 'selected' : '' ?>>24K Gold</option>
