    ...
    <div class="card mb-4">
      <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
        ...
        <div class="d-flex gap-2 flex-wrap">
          <?php if (!$isInvoiced && has_permission('challan.edit')): ?>
          ...
          <?php if (!empty($nextStatuses) && has_permission('challan.edit')): ?>
            <div class="btn-group">
          ...
          <?php if (!$isInvoiced && has_permission('challan.delete')): ?>
  ...
  <div class="col-xl-4 col-lg-5">
    ...
    <div class="card mb-4">
      <div class="card-body">
        ...
        <?php if ($challanStatus === 'Completed' && !$isInvoiced && has_permission('challan.edit')): ?>
