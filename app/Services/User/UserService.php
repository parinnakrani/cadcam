...
class UserService
{
  ...
  public function createUser(array $data): int
  {
    ...
    try {
      ...
      // 4. Audit
      $this->auditService->logCreate('User', 'User', $userId, $data);
  ...
  public function updateUser(int $id, array $data): bool
  {
    ...
    try {
      ...
      // Audit
      $this->auditService->logUpdate('User', 'User', $id, [], $data); // old data retrieval omitted for perf unless needed, or use $existing
  ...
  public function deleteUser(int $id): bool
  {
    ...
    try {
      ...
      // Audit
      $this->auditService->logDelete('User', 'User', $id, $existing);
  ...
  public function assignRoles(int $userId, array $roleIds): bool
  {
    ...
    // Audit
    $this->auditService->log('User', 'update', 'User', $userId, null, ['role_ids' => $roleIds]);
  ...
  public function changePassword(int $userId, string $currentPassword, string $newPassword): bool
  {
    ...
    $this->auditService->log('User', 'update', 'User', $userId, null, ['action' => 'password_change']);
  ...
  public function resetPassword(int $userId, string $newPassword): bool
  {
    ...
    $this->auditService->log('User', 'update', 'User', $userId, null, ['action' => 'password_reset_by_admin']);
