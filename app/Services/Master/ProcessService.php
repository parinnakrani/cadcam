...
class ProcessService
{
  ...
  public function createProcess(array $data): int
  {
    ...
    $this->auditService->log(
      ...
      $processId,
      null,
      ['process_name' => $data['process_name'], 'process_code' => $data['process_code'], 'rate_per_unit' => $data['rate_per_unit']]
    );
  ...
  public function updateProcess(int $id, array $data): bool
  {
    ...
    if (isset($data['rate_per_unit']) && (float)$data['rate_per_unit'] !== (float)$process['rate_per_unit']) {
      ...
      $this->auditService->log(
        ...
        'Process',
        $id,
        ['rate_per_unit' => $process['rate_per_unit']],
        ['rate_per_unit' => $data['rate_per_unit'], 'note' => 'price_change']
      );
    }
    ...
    $this->auditService->log(
      ...
      'Process',
      $id,
      ['process_name' => $process['process_name'], 'process_code' => $process['process_code']],
      $data
    );
