...
class ProductCategoryService
{
    ...
    public function createCategory(array $data): int
    {
        ...
        // Audit Log
        $this->auditService->logAction('product_category.create', $id, $data['category_code'], 'Created Product Category');
    ...
    public function updateCategory(int $id, array $data): bool
    {
        ...
        $this->auditService->logAction('product_category.update', $id, $category['category_code'], 'Updated Product Category');
    ...
    public function deleteCategory(int $id): bool
    {
        ...
        $this->auditService->logAction('product_category.delete', $id, $category['category_code'], 'Deleted Product Category');
