...
class AccountService
{
  ...
  public function createAccount(array $data): int
  {
    ...
    try {
      ...
      // 8. Audit Log
      $this->auditService->log('Customer', 'create', 'Account', $accountId, null, $data);
  ...
  public function updateAccount(int $id, array $data): bool
  {
    ...
    // Audit Log
    $this->auditService->log('Customer', 'update', 'Account', $id, $existing, $data);
  ...
  public function deleteAccount(int $id): bool
  {
    ...
    // Audit
    $this->auditService->log('Customer', 'delete', 'Account', $id, $existing, null);
  ...
  {
    // LedgerService has no getAccountBalance() — read current_balance from the account model directly
    $account = $this->accountModel->find($accountId);
    return (float)($account['current_balance'] ?? 0.00);
  }
  ...
  {
    // Delegate to LedgerService using the correct method name and signature
    $this->ledgerService->createOpeningBalanceLedgerEntry($accountId, 'Account', $amount, $type);
  }
