...
class RoleController extends BaseController
{
  ...
  public function index(): string
  {
    ...
    if ($this->permissions) {
      $data['action_flags'] = $this->permissions->getActionFlags('roles', 'all');
    }
  ...
  {
    $this->gate('roles.all.manage_permissions');
    ...
    return $this->render('Roles/permissions', $data);
  }
