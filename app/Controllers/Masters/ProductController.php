...
class ProductController extends BaseController
{
  ...
  {
    try {
      $this->gate('masters.products.all.list');
    ...
    if ($this->permissions) {
      $data['action_flags'] = $this->permissions->getActionFlags('masters', 'products.all');
    }

    return $this->render('Masters/Products/index', $data);
  }
  ...
  {
    $this->gate('masters.products.all.create');
    ...
    return $this->render('Masters/Products/create', $data);
  }
  ...
  {
    $this->gate('masters.products.all.view');
    ...
    return $this->render('Masters/Products/show', $data);
  }
  ...
  {
    $this->gate('masters.products.all.edit');
    ...
    return $this->render('Masters/Products/edit', $data);
  }
  ...
  {
    if (!can('masters.products.all.delete')) {
      return $this->response->setJSON(['status' => 'error', 'message' => 'Access Denied'])->setStatusCode(403);
    }
  ...
  {
    if (!can('masters.products.all.list')) {
      return $this->response->setJSON(['status' => 'error', 'message' => 'Access Denied'])->setStatusCode(403);
    }
