...
class ProcessController extends BaseController
{
  ...
  {
    try {
      $this->gate('masters.processes.all.list');
    ...
    if ($this->permissions) {
      $data['action_flags'] = $this->permissions->getActionFlags('masters', 'processes.all');
    }

    return $this->render('Masters/Processes/index', $data);
  }
  ...
  {
    $this->gate('masters.processes.all.create');
    ...
    return $this->render('Masters/Processes/create', $data);
  }
  ...
  {
    $this->gate('masters.processes.all.view');
    ...
    return $this->render('Masters/Processes/show', $data);
  }
  ...
  {
    $this->gate('masters.processes.all.edit');
    ...
    return $this->render('Masters/Processes/edit', $data);
  }
  ...
  {
    if (!can('masters.processes.all.delete')) {
      return $this->response->setJSON(['status' => 'error', 'message' => 'Access Denied'])->setStatusCode(403);
    }
  ...
  {
    if (!can('masters.processes.all.list')) {
      return $this->response->setJSON(['status' => 'error', 'message' => 'Access Denied'])->setStatusCode(403);
    }
